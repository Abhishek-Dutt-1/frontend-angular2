...
export var MOCK_GROUPS: Group[] = [
  {
    ...
    //parent_group: [MOCK_GROUP_OF_GROUPS[0], MOCK_GROUP_OF_GROUPS[5]]
  },
  {
    id: 1,
    name: 'random',
    //parent_group: [MOCK_GROUP_OF_GROUPS[0], MOCK_GROUP_OF_GROUPS[3], MOCK_GROUP_OF_GROUPS[5]]
  },
  {
    id: 2,
    name: 'funny',
    //parent_group: [MOCK_GROUP_OF_GROUPS[1], MOCK_GROUP_OF_GROUPS[4]]
  },
  {
    id: 3,
  ...
  },
  {
    id: 4,
    name: 'one_true_god',
    //parent_group: [MOCK_GROUP_OF_GROUPS[2], MOCK_GROUP_OF_GROUPS[4]]
  },
  {
    id: 5,
